...
public final class Fishing {
    ...
    public static Set<Biome> iceFishingBiomes = EnumSet.of(
            ...
            Biome.TAIGA, Biome.TAIGA_HILLS, Biome.TAIGA_HILLS,
            Biome.ICE_FLATS, Biome.ICE_MOUNTAINS, Biome.ICE_MOUNTAINS,
            Biome.TAIGA_COLD, Biome.TAIGA_COLD_HILLS, Biome.MUTATED_TAIGA_COLD);
